(function process(/*RESTAPIRequest*/ request, /*RESTAPIResponse*/ response) {
    ...
    gr.initialize();
    gr.setValue('u_schedule', body.schedule);
    gr.setValue('u_offset_minutes', body.offset_minutes || 0);
    ...
    // Derive hauler from schedule so they can never diverge
    if (body.schedule) {
        var sg = new GlideRecord('x_1986056_sugbocle_schedule');
        if (sg.get(body.schedule)) {
            gr.setValue('u_hauler', sg.getValue('u_hauler'));
        }
    }
